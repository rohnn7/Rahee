...
const SigninScreen = ({navigation}) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Spacer>
                <Text h3 style={styles.head}>Login </Text>
            </Spacer>
            <View>
                ...
                <Spacer>
                    <Button title='Sign In'  onPress={signin} containerStyle={styles.button} buttonStyle={{backgroundColor:'#34eb9b'}} />
                </Spacer>
